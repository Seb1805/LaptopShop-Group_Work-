...
namespace LaptopShop_MVC.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public AddressesController(LaptopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AddressId,Street,PostalCode,CustomerId")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AddressId,Street,PostalCode,CustomerId")] Address address)
        {
